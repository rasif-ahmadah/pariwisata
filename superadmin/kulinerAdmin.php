...
print_r($_POST);
  ...
  if( 
    ...
    isset($_POST['pengunjung']) && isset($_POST['artikel'])&& isset($_POST['harga'])&&
    isset($_POST['RKNWeekend'])&&
    ...
    isset($_POST['JrProv'])&&isset($_POST['JrKab'])
      ...
      echo "masuk";
        ...
        $idKuliner = htmlentities(strip_tags(trim($_POST['id_wisata'])));
        ...
        if($_FILES["foto"]['error'] == 0){
          ...
          $ext= count($foto)-1;
          $target_dir = "../images/kuliner/";
          $nama_file="kuliner_$nKuliner.".$foto[$ext];
          ...
          // if everything is ok, try to upload file
              ...
              if (move_uploaded_file($_FILES['foto']["tmp_name"], $target_file)) {
                ...
                if(updateKuliner($connect,$where,$myvalue))
    ...
    isset($_POST['harga'])&&isset($_POST['RKNWeekend'])&&
    isset($_POST['RKNWeekday'])&&isset($_POST['RKMWeekend'])&&
    isset($_POST['RKMWeekday'])&&isset($_POST['JSenin'])&&
    isset($_POST['JSelasa'])&&isset($_POST['JRabu'])&&
    isset($_POST['JKamis'])&&isset($_POST['JJumat'])&&
    ...
    isset($_POST['JrProv'])&&isset($_POST['JrKab'])
        ...
        $dataKuliner=showKuliner($connect,$myvalue);
        $idKuliner=$dataKuliner[0]['id'];
  ...
  else if( isset($_POST['deleteKuliner'])){
    $message="Data gagal dihapus";
    if(deleteKuliner($connect,"id",$_POST['deleteKuliner'])){
...
<!DOCTYPE html>
  <html>
        ...
        <div id="modDelArtikel" class="modal">
          <div class="modal-content" id="delContent">
            ...
            <form action="" method="POST">
                <input type="hidden" value="" name="deleteKuliner" id="idModKuliner">
    ...
    <!-- ========================================================================= -->
      ...
      <h4><b>List Destinasi Kuliner</b><a href="#modAddArtikel" class="modal-trigger btn-floating blue right"><i class="material-icons">add</i></a></h4>
      <table class=" striped highlight">
        ...
        <tbody>
          <?php
            $dataKuliner=showKuliner($connect,"all");
            for($a=0;$a<sizeof($dataKuliner);$a++){
          ?>
          <tr>
            <td><?php echo $dataKuliner[$a]['judul']; ?></td>
            <td><?php echo $dataKuliner[$a]['koordinat']; ?></td>
            <td><?php echo $dataKuliner[$a]['pengunjung']; ?></td>
            <td><a href="<?php echo $URL."/detail_artikel?k=kuliner&i=".$dataKuliner[$a]['id']; ?>" class="material-icons">visibility</a></td>
            <td><a href="#modEditArtikel" class="modal-trigger material-icons" onclick="setEdit(<?php echo $dataKuliner[$a]['id']; ?>)">edit</a></td>
            <td><a href="#modDelArtikel" class="modal-trigger material-icons"  onclick="setDelete(<?php echo $dataKuliner[$a]['id']; ?>)">delete</a></td>
          </tr>
          <?php
            }
          ?>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js"></script>
	  <script>
        ...
        function setEdit(x){
          $("#editContent").load("<?php echo $URL; ?>/superadmin/modContent.php?editKuliner="+x);
        }

        function setDelete(x){
          document.getElementById("idModKuliner").value=x;
        }
  </script>
